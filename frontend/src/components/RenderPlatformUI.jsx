...
export default function RenderPlatformUI() {
  ...
  switch (platform) {
    case "Instagram":
      return <Instagram sender={sender} receiver={receiver} messages={messages} receiverAvatar={receiverAvatar} />;
    case "WhatsApp":
      return <WhatsApp sender={sender} receiver={receiver} messages={messages} receiverAvatar={receiverAvatar} />;
    default:
      return <WhatsApp sender={sender} receiver={receiver} messages={messages} receiverAvatar={receiverAvatar} />; 
  }
}
