        ...
        <button
          ...
          {finalImageUrl ? (
            ...
            <div aria-hidden="true">
              <CircleUserRoundIcon className="size-14 opacity-60" />
            </div>
          )}
        </button>
